...
#define DC_FB_CONFIG1			 (DC_BASE + 0x000)
#define DC_FB_BUFFER_ADDR01		 (DC_BASE + 0x020)
#define DC_FB_BUFFER_STRIDE1		 (DC_BASE + 0x040)
#define DC_FB_BUFFER_ORIGIN1		 (DC_BASE + 0x060)
#define DC_DITHER_CONFIG1		 (DC_BASE + 0x120)
#define DC_DITHER_TABLE_LOW1		 (DC_BASE + 0x140)
#define DC_DITHER_TABLE_HIGH1	 (DC_BASE + 0x160)
#define DC_PANEL_CONFIG1			 (DC_BASE + 0x180)
#define DC_PANEL_TIMING1			 (DC_BASE + 0x1A0)
#define DC_HDISPLAY1				 (DC_BASE + 0x1C0)
#define DC_HSYNC1				 (DC_BASE + 0x1E0)
#define DC_VDISPLAY1				 (DC_BASE + 0x240)
#define DC_VSYNC1				 (DC_BASE + 0x260)
#define DC_FB_BUFFER_ADDR11		 (DC_BASE + 0x340)
